<html><head>        
        ...
        <script type="text/javascript" src="${resource(dir: 'js/plugins/jquery-validation/', file: 'jquery.validate.min.js')}"></script>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content page-content-default mCustomScrollbar _mCS_1"><div class="mCustomScrollBox mCS-light" id="mCSB_1" style="position:relative; height:100%; overflow:hidden; max-width:100%;"><div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                ...
                <div class="block-login">
                    ...
                    <div class="block-login-content">
                        ...
                        <div class="form-group">                        
                            <input type="text" name="login" class="form-control" placeholder="Sua chave de acesso" value="">
                        </div>
                        <div class="form-group">                        
                            <input type="password" name="password" class="form-control" placeholder="Sua senha" value="">
                        </div>
                        <g:link class="btn btn-primary btn-block" resource="index">Entrar</g:link>
                        </form>
                    </div>
